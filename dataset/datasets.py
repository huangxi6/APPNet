...
from dataset.generate_seg import generate_seg
...
class HumanDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.dataset != 'train':
            ...
            label_seg1 = generate_seg(label_parsing)

            label_parsing = torch.from_numpy(label_parsing)
            label_seg1 = torch.from_numpy(label_seg1)
            #label_seg2 = torch.from_numpy(label_seg2)

            return input, label_parsing, label_seg1, meta
